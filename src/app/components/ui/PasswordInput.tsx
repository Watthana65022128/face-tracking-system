...
interface PasswordInputProps {
  ...
  showToggle?: boolean // เพิ่ม prop ใหม่สำหรับควบคุมการแสดงปุ่ม toggle
  error?: string
}
...
export function PasswordInput({ 
  ...
  required = false,
  showStrength = false,
  showToggle = true, // default เป็น true เพื่อไม่ให้กระทบกับการใช้งานเดิม
  error 
}: PasswordInputProps) {
